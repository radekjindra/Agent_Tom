...
{
/**
 * Po zbourání databáze jsem převzal s: 
 * https://stackoverflow.com/questions/2170182/how-to-backup-mysql-database-in-php
 * následující script pro bezpečnostní zálohu své databáze děkuji autorům
 * 
 * Použití
 * ZalohaDB::init("localhost","root","","db_pojistenci","./zalohyDb" );
 */
